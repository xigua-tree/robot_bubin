...
void my_led_test(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  led_testHandle = osThreadNew(my_led_test, NULL, &led_test_attributes);
...
/* USER CODE BEGIN Header_my_led_test */
/**
* @brief Function implementing the led_test thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_my_led_test */
void my_led_test(void *argument)
{
  /* USER CODE BEGIN my_led_test */
  /* Infinite loop */
  for(;;)
  {
